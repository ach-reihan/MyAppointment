<x-app-layout :title="'Master Data Management – My Appointment'">
    ...
    <div x-data="{ 
        ...
        async saveData() {
            const baseUrl = '{{ url('/admin/master-data/users') }}';
    ...
    >
        ...
        <div class="flex flex-wrap gap-2 mb-6 bg-slate-100 p-1.5 rounded-xl w-max border border-slate-200/60">
            <a href="{{ route('admin.master-data.users') }}" class="px-4 py-2 text-xs font-semibold rounded-lg bg-white text-blue-600 shadow-sm transition-all">Manajemen User</a>
            <a href="{{ route('admin.master-data.doctors') }}" class="px-4 py-2 text-xs font-semibold rounded-lg text-slate-600 hover:text-slate-900 transition-colors">Data Dokter</a>
            <a href="{{ route('admin.master-data.patients') }}" class="px-4 py-2 text-xs font-semibold rounded-lg text-slate-600 hover:text-slate-900 transition-colors">Data Pasien</a>
            <a href="{{ route('admin.master-data.polyclinics') }}" class="px-4 py-2 text-xs font-semibold rounded-lg text-slate-600 hover:text-slate-900 transition-colors">Data Poliklinik</a>
        </div>
