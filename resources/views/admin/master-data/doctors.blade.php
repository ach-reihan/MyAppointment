<x-app-layout :title="'Data Dokter – My Appointment'">
    ...
    <div x-data="{ 
        ...
        <div class="flex flex-wrap gap-2 mb-6 bg-slate-100 p-1.5 rounded-xl w-max border border-slate-200/60">
            ...
            <a href="{{ route('admin.master-data.doctors') }}" class="px-4 py-2 text-xs font-semibold rounded-lg bg-white text-blue-600 shadow-sm transition-all">
                Data Dokter
            </a>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            <div class="p-5 flex items-center justify-between border-b border-slate-100 flex-wrap gap-4">
                <div>
                    <h2 class="text-sm font-bold text-slate-800">Daftar Tenaga Medis</h2>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-slate-50/70 border-b border-slate-100">
                            ...
                            <th class="px-6 py-3.5 text-xs font-bold text-slate-400 tracking-wider">NAMA DOKTER</th>
                            <th class="px-6 py-3.5 text-xs font-bold text-slate-400 tracking-wider">SPESIALISASI</th>
                            <th class="px-6 py-3.5 text-xs font-bold text-slate-400 tracking-wider">POLI TUGASAN</th>
        ...
        <div x-show="openModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" style="display: none;">
            ...
            >
                ...
                <div x-show="!isEdit">
                    @include('admin.form.doctor.create')
                </div>
