<form @submit.prevent="saveData()" class="p-6 space-y-4">
    ...
    <div>
        ...
        <div>
            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">Deskripsi
                Layanan</label>
        ...
        <div>
            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">Status
                Operasional</label>
            <div class="relative">
