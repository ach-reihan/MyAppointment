<form @submit.prevent="alert('Poliklinik Baru Berhasil Ditambahkan!'); openModal = false;" class="p-6 space-y-4">
    <div>
    ...
    <div>
        ...
        <textarea 
            x-model="deskripsi"
            rows="3"
            placeholder="Jelaskan layanan yang tersedia pada poliklinik ini..."
            required
